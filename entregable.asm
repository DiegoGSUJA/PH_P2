...
.c_loop:
    ...
    jne .not_equal  ; Si son distintos, salta
    or al, al       ; ¿Es el fin de la cadena (0)?
    jz .equal       ; Si ambos son 0, son iguales
    inc si
    inc di
    jmp .c_loop
.not_equal:
    mov al, 1       ; Cargamos un valor distinto de cero
    or al, al       ; Esto fuerza a que el Zero Flag (ZF) sea 0 (Indica NO IGUAL)
    ret
.equal:
    xor ax, ax      ; Esto pone AX a 0 y activa el Zero Flag (ZF=1) (Indica IGUAL)
    ret
